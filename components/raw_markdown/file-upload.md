...
`npx shadcn@latest add @aceternity/file-upload-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/file-upload-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/file-upload-demo.json)

Upload file

Drag or drop your files here or click to upload

## [Link to section](https://ui.aceternity.com/components/file-upload\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/file-upload\#props) Props

| Prop Name | Type | Default | Description |
| --- | --- | --- | --- |
| `onChange` | `(files: File[]) => void` | undefined | Callback function that is called when files are uploaded or dropped. |

The overall theme and initial design of this component is inspied by [Natko Hasic](https://x.com/natkohasic/status/1821563382551458272)
