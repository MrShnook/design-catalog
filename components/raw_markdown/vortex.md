...
[background](https://ui.aceternity.com/categories/background) [special](https://ui.aceternity.com/categories/special) [CTA](https://ui.aceternity.com/categories/cta)

PreviewCode

`npx shadcn@latest add @aceternity/vortex-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/vortex-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/vortex-demo.json)

## The hell is this?

This is chemical burn. It'll hurt more than you've ever been burned and you'll have a scar.

Order nowWatch trailer

## [Link to section](https://ui.aceternity.com/components/vortex\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/vortex\#full-page-demo-usage) Full page demo usage

PreviewCode

`npx shadcn@latest add @aceternity/vortex-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/vortex-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/vortex-demo-2.json)
...
## [Link to section](https://ui.aceternity.com/components/vortex\#props) Props
...
This component is inspired by [this GitHub Repo](https://github.com/crnacura/AmbientCanvasBackgrounds)
