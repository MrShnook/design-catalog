...
[carousel](https://ui.aceternity.com/categories/carousel) [special](https://ui.aceternity.com/categories/special) [features](https://ui.aceternity.com/categories/features)

PreviewCode

`npx shadcn@latest add @aceternity/carousel-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/carousel-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/carousel-demo.json)

![Mystic Mountains](https://images.unsplash.com/photo-1494806812796-244fe51b774d?q=80&w=3534&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)

## Mystic Mountains

Explore Component

![Urban Dreams](https://images.unsplash.com/photo-1518710843675-2540dd79065c?q=80&w=3387&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)

## Urban Dreams

Explore Component

![Neon Nights](https://images.unsplash.com/photo-1590041794748-2d8eb73a571c?q=80&w=3456&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)

## Neon Nights

Explore Component

![Desert Whispers](https://images.unsplash.com/photo-1679420437432-80cfbf88986c?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)

## Desert Whispers

Explore Component

## [Link to section](https://ui.aceternity.com/components/carousel\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/carousel\#props) Props

### [Link to section](https://ui.aceternity.com/components/carousel\#carousel-component-props) Carousel Component Props

| Prop | Type | Required | Description |
| --- | --- | --- | --- |
| `slides` | `SlideData[]` | Yes | Array of slide objects containing title, button text, and image source |

#### [Link to section](https://ui.aceternity.com/components/carousel\#slidedata-interface) SlideData Interface
...
### [Link to section](https://ui.aceternity.com/components/carousel\#slide-component-props) Slide Component Props
...
### [Link to section](https://ui.aceternity.com/components/carousel\#carouselcontrol-component-props) CarouselControl Component Props
