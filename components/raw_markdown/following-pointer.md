...
[feature](https://ui.aceternity.com/categories/feature) [utility](https://ui.aceternity.com/categories/utility) [special](https://ui.aceternity.com/categories/special)

PreviewCode

`npx shadcn@latest add @aceternity/following-pointer-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/following-pointer-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/following-pointer-demo.json)

![thumbnail](https://ui.aceternity.com/demo/thumbnail.png)
...
## [Link to section](https://ui.aceternity.com/components/following-pointer\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/following-pointer\#props) Props

## [Link to section](https://ui.aceternity.com/components/following-pointer\#followerpointercard-props) FollowerPointerCard Props
