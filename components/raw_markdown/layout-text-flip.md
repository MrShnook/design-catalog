...
[text](https://ui.aceternity.com/categories/text) [hero](https://ui.aceternity.com/categories/hero) [effect](https://ui.aceternity.com/categories/effect)

PreviewCode

`npx shadcn@latest add @aceternity/layout-text-flip-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/layout-text-flip-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/layout-text-flip-demo.json)

Welcome to Aceternity UI

Experience the power of modern UI components that bring your ideas to life.

## [Link to section](https://ui.aceternity.com/components/layout-text-flip\#installation) Installation
...
#### [Link to section](https://ui.aceternity.com/components/layout-text-flip\#props) Props

#### [Link to section](https://ui.aceternity.com/components/layout-text-flip\#layout-text-flip-props) Layout Text Flip Props

| Prop | Type | Default | Description | Required |
| --- | --- | --- | --- | --- |
| `text` | `string` | `"Build Amazing"` | The static text that appears before the flipping words | Yes |
| `words` | `string[]` | `["Landing Pages", "Component Blocks", "Page Sections", "3D Shaders"]` | Array of words/phrases to cycle through | Yes |
| `duration` | `number` | `3000` | Duration in milliseconds between word transitions | No |
