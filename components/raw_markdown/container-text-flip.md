...
[text](https://ui.aceternity.com/categories/text) [animation](https://ui.aceternity.com/categories/animation) [container](https://ui.aceternity.com/categories/container) [hero](https://ui.aceternity.com/categories/hero)

PreviewCode

`npx shadcn@latest add @aceternity/container-text-flip-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/container-text-flip-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/container-text-flip-demo.json)

TylerDurden

## [Link to section](https://ui.aceternity.com/components/container-text-flip\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/container-text-flip\#examples) Examples

#### [Link to section](https://ui.aceternity.com/components/container-text-flip\#standard) Standard
...
#### [Link to section](https://ui.aceternity.com/components/container-text-flip\#hero-section-with-animation) Hero section with animation

PreviewCode

`npx shadcn@latest add @aceternity/container-text-flip-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/container-text-flip-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/container-text-flip-demo-2.json)

# Make your websites look 10x         beautiful

## [Link to section](https://ui.aceternity.com/components/container-text-flip\#props) Props
