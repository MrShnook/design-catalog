...
[section](https://ui.aceternity.com/categories/section) [special](https://ui.aceternity.com/categories/special) [call to action](https://ui.aceternity.com/categories/call-to-action) [hero](https://ui.aceternity.com/categories/hero)

PreviewCode

`npx shadcn@latest add @aceternity/sparkles-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/sparkles-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/sparkles-demo.json)

# Aceternity

## [Link to section](https://ui.aceternity.com/components/sparkles\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/sparkles\#examples) Examples

PreviewCode

`npx shadcn@latest add @aceternity/sparkles-fullpage-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/sparkles-fullpage-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/sparkles-fullpage-demo.json)

# Build great products

## [Link to section](https://ui.aceternity.com/components/sparkles\#props) Props
