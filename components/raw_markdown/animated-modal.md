...
[special](https://ui.aceternity.com/categories/special) [utilities](https://ui.aceternity.com/categories/utilities) [modal](https://ui.aceternity.com/categories/modal)

PreviewCode

`npx shadcn@latest add @aceternity/animated-modal-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/animated-modal-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/animated-modal-demo.json)

Book your flight
✈️

## [Link to section](https://ui.aceternity.com/components/animated-modal\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/animated-modal\#props) props

#### [Link to section](https://ui.aceternity.com/components/animated-modal\#modalprovider) ModalProvider
...
#### [Link to section](https://ui.aceternity.com/components/animated-modal\#modaltrigger) ModalTrigger
...
#### [Link to section](https://ui.aceternity.com/components/animated-modal\#modalbody) ModalBody
...
#### [Link to section](https://ui.aceternity.com/components/animated-modal\#modalcontent) ModalContent
...
#### [Link to section](https://ui.aceternity.com/components/animated-modal\#modalfooter) ModalFooter
...
#### [Link to section](https://ui.aceternity.com/components/animated-modal\#overlay) Overlay

| Prop | Type | Description |
| --- | --- | --- |
| className | string? | Optional additional class names for the overlay. |

#### [Link to section](https://ui.aceternity.com/components/animated-modal\#useoutsideclick) useOutsideClick
