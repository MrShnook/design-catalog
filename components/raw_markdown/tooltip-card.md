...
[tooltip](https://ui.aceternity.com/categories/tooltip) [card](https://ui.aceternity.com/categories/card) [special](https://ui.aceternity.com/categories/special) [call to action](https://ui.aceternity.com/categories/call-to-action) [Informative](https://ui.aceternity.com/categories/informative)

PreviewCode

`npx shadcn@latest add @aceternity/tooltip-card-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/tooltip-card-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/tooltip-card-demo.json)

There was a problem with the server. Once

AWS

went down, we had to quickly migrate to a new provider. AWS in general is a great service, but sometimes it's not available.

The server was administered by

Tyler Durden.

Tyler has been with us for a long time. He is a great asset to the team and sometimes tries to act in different ways which can be difficult to manage.

That is when we approached Tyler for a cute little

testimonial.

Instead of a testimonial, he started yapping about project mayhem and how we should be using our skills to build a better future.

## [Link to section](https://ui.aceternity.com/components/tooltip-card\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/tooltip-card\#props) Props

#### [Link to section](https://ui.aceternity.com/components/tooltip-card\#tooltip-props) Tooltip Props

| Prop | Type | Default | Description | Required |
| --- | --- | --- | --- | --- |
| `content` | `string | React.ReactNode` | - | The content to display inside the tooltip. | Yes |
| `children` | `React.ReactNode` | - | The element that triggers the tooltip on hover/touch. | Yes |
| `containerClassName` | `string` | - | Additional CSS classes to apply to the tooltip container. | No |
