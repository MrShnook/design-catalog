...
`npx shadcn@latest add @aceternity/card-spotlight-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/card-spotlight-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/card-spotlight-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/card-spotlight\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/card-spotlight\#props) Props
