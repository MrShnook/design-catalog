...
`npx shadcn@latest add @aceternity/direction-aware-hover-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/direction-aware-hover-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/direction-aware-hover-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/direction-aware-hover\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/direction-aware-hover\#props) Props
