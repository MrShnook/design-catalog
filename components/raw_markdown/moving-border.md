...
[button](https://ui.aceternity.com/categories/button) [special](https://ui.aceternity.com/categories/special) [card](https://ui.aceternity.com/categories/card) [utility](https://ui.aceternity.com/categories/utility)

PreviewCode

`npx shadcn@latest add @aceternity/moving-border-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/moving-border-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/moving-border-demo.json)

Borders are cool

## [Link to section](https://ui.aceternity.com/components/moving-border\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/moving-border\#props) Props
