...
## [Link to section](https://ui.aceternity.com/blocks/cards\#feature-block-animated-card) Feature Block Animated Card

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/cards-demo-3)

### Damn good card

A card that showcases a set of tools that you use to create your product.

## [Link to section](https://ui.aceternity.com/blocks/cards\#expandable-card-on-click) Expandable Card On Click

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/expandable-card-on-click)

![Classic look](https://assets.aceternity.com/pro/car-1.jpg)

Classic look

The best in class design.

![Offroading](https://assets.aceternity.com/pro/car-2.jpg)

Offroading

Comes with a 4x4 offroading system.

![7 Seater](https://assets.aceternity.com/pro/car-3.jpg)

7 Seater

Enough space for your family.

![Low maintenence](https://assets.aceternity.com/pro/car-4.jpg)

Low maintenence

No maintenence is required, ever.

## [Link to section](https://ui.aceternity.com/blocks/cards\#background-overlay-card) Background Overlay Card

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/cards-demo-1)

# Background Overlays

This card is for some special elements, like displaying background gifs on hover only.

## [Link to section](https://ui.aceternity.com/blocks/cards\#content-card) Content Card

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/cards-demo-2)
