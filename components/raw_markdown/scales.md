...
[background](https://ui.aceternity.com/categories/background) [pattern](https://ui.aceternity.com/categories/pattern) [special](https://ui.aceternity.com/categories/special)

PreviewCode

`npx shadcn@latest add @aceternity/scales-with-image-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/scales-with-image-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/scales-with-image-demo.json)

![Portrait](https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=1288&auto=format&fit=crop)

## [Link to section](https://ui.aceternity.com/components/scales\#installation) Installation
...
```
npx shadcn@latest add @aceternity/scales
Copy
```

## [Link to section](https://ui.aceternity.com/components/scales\#horizontal-scales) Horizontal Scales

PreviewCode

`npx shadcn@latest add @aceternity/scales-horizontal-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/scales-horizontal-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/scales-horizontal-demo.json)

## Horizontal Scales

## [Link to section](https://ui.aceternity.com/components/scales\#vertical-scales) Vertical Scales

PreviewCode

`npx shadcn@latest add @aceternity/scales-vertical-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/scales-vertical-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/scales-vertical-demo.json)

## Vertical Scales

## [Link to section](https://ui.aceternity.com/components/scales\#scales-container) Scales Container

A wrapper component that makes it easy to add scales behind any content.

PreviewCode

`npx shadcn@latest add @aceternity/scales-container-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/scales-container-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/scales-container-demo.json)

## Scales Container

Wrap your content with the ScalesContainer component for a clean API.

## [Link to section](https://ui.aceternity.com/components/scales\#scales-with-image) Scales with Image
...
## [Link to section](https://ui.aceternity.com/components/scales\#props) Props

#### [Link to section](https://ui.aceternity.com/components/scales\#scales-props) Scales Props
...
#### [Link to section](https://ui.aceternity.com/components/scales\#scalescontainer-props) ScalesContainer Props
