...
[card](https://ui.aceternity.com/categories/card) [features](https://ui.aceternity.com/categories/features) [special](https://ui.aceternity.com/categories/special)

PreviewCode

`npx shadcn@latest add @aceternity/compare-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/compare-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/compare-demo.json)

![first image](https://assets.aceternity.com/code-problem.png)

![second image](https://assets.aceternity.com/code-solution.png)

## [Link to section](https://ui.aceternity.com/components/compare\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/compare\#examples) Examples

### [Link to section](https://ui.aceternity.com/components/compare\#standard) Standard
...
### [Link to section](https://ui.aceternity.com/components/compare\#autoplay) Autoplay

PreviewCode

`npx shadcn@latest add @aceternity/compare-autoplay-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/compare-autoplay-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/compare-autoplay-demo.json)

![first image](https://assets.aceternity.com/notes-dark.png)

![second image](https://assets.aceternity.com/linear-dark.png)

## [Link to section](https://ui.aceternity.com/components/compare\#drag-mode) Drag Mode

PreviewCode

`npx shadcn@latest add @aceternity/compare-drag-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/compare-drag-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/compare-drag-demo.json)

![first image](https://assets.aceternity.com/notes-dark.png)

![second image](https://assets.aceternity.com/linear-dark.png)

## [Link to section](https://ui.aceternity.com/components/compare\#props) Props
