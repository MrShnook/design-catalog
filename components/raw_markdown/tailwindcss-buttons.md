...
[button](https://ui.aceternity.com/categories/button) [utility](https://ui.aceternity.com/categories/utility)

PreviewCode

`npx shadcn@latest add @aceternity/tailwindcss-buttons-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/tailwindcss-buttons-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/tailwindcss-buttons-demo.json)
...
All the buttons can be copied directly from the preview. The source code is
also available in the [Installation](https://ui.aceternity.com/components/tailwindcss-buttons#installation) section.

## [Link to section](https://ui.aceternity.com/components/tailwindcss-buttons\#installation-optional) Installation (optional)

### Install dependencies

```
npm i motion clsx tailwind-merge react-element-to-jsx-stringCopy
```
