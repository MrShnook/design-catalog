...
[sidebar](https://ui.aceternity.com/categories/sidebar) [special](https://ui.aceternity.com/categories/special) [utilities](https://ui.aceternity.com/categories/utilities) [dashboard](https://ui.aceternity.com/categories/dashboard)

PreviewCode

`npx shadcn@latest add @aceternity/sidebar-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/sidebar-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/sidebar-demo.json)

[Dashboard](https://ui.aceternity.com/components/sidebar#) [Profile](https://ui.aceternity.com/components/sidebar#) [Settings](https://ui.aceternity.com/components/sidebar#) [Logout](https://ui.aceternity.com/components/sidebar#)

[![Avatar](https://assets.aceternity.com/manu.png)Manu Arora](https://ui.aceternity.com/components/sidebar#)

## [Link to section](https://ui.aceternity.com/components/sidebar\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/sidebar\#example) Example

### [Link to section](https://ui.aceternity.com/components/sidebar\#default-sidebar-open) Default sidebar open

use the prop `animate={false}` to disable the animation

PreviewCode

`npx shadcn@latest add @aceternity/sidebar-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/sidebar-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/sidebar-demo-2.json)

[Acet Labs](https://ui.aceternity.com/components/sidebar#)

[Dashboard](https://ui.aceternity.com/components/sidebar#) [Profile](https://ui.aceternity.com/components/sidebar#) [Settings](https://ui.aceternity.com/components/sidebar#) [Logout](https://ui.aceternity.com/components/sidebar#)

[![Avatar](https://assets.aceternity.com/manu.png)Manu Arora](https://ui.aceternity.com/components/sidebar#)

## [Link to section](https://ui.aceternity.com/components/sidebar\#props) Props

### [Link to section](https://ui.aceternity.com/components/sidebar\#sidebarprovider-props) SidebarProvider Props
...
### [Link to section](https://ui.aceternity.com/components/sidebar\#sidebar-props) Sidebar Props
...
### [Link to section](https://ui.aceternity.com/components/sidebar\#sidebarbody-props) SidebarBody Props

| Prop Name | Type | Default | Description |
| --- | --- | --- | --- |
| props | `React.ComponentProps<typeof motion.div>` | - | Props to be passed to the motion.div component. |

### [Link to section](https://ui.aceternity.com/components/sidebar\#desktopsidebar-props) DesktopSidebar Props
...
### [Link to section](https://ui.aceternity.com/components/sidebar\#mobilesidebar-props) MobileSidebar Props
...
### [Link to section](https://ui.aceternity.com/components/sidebar\#sidebarlink-props) SidebarLink Props
...
### [Link to section](https://ui.aceternity.com/components/sidebar\#links-interface) Links Interface
...
### [Link to section](https://ui.aceternity.com/components/sidebar\#sidebarcontextprops-interface) SidebarContextProps Interface
