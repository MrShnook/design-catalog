...
[background](https://ui.aceternity.com/categories/background) [ripple](https://ui.aceternity.com/categories/ripple) [effect](https://ui.aceternity.com/categories/effect)

PreviewCode

`npx shadcn@latest add @aceternity/background-ripple-effect-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/background-ripple-effect-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/background-ripple-effect-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/background-ripple-effect\#installation) Installation
...
#### [Link to section](https://ui.aceternity.com/components/background-ripple-effect\#props) Props

#### [Link to section](https://ui.aceternity.com/components/background-ripple-effect\#background-ripple-effect-props) Background Ripple Effect Props
...
#### [Link to section](https://ui.aceternity.com/components/background-ripple-effect\#divgrid-props) DivGrid Props
