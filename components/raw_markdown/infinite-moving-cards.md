...
[testimonials](https://ui.aceternity.com/categories/testimonials) [utility](https://ui.aceternity.com/categories/utility) [marquee](https://ui.aceternity.com/categories/marquee)

PreviewCode

`npx shadcn@latest add @aceternity/infinite-moving-cards-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/infinite-moving-cards-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/infinite-moving-cards-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/infinite-moving-cards\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/infinite-moving-cards\#props) Props
