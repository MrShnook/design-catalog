...
[button](https://ui.aceternity.com/categories/button) [stateful](https://ui.aceternity.com/categories/stateful) [loading](https://ui.aceternity.com/categories/loading)

PreviewCode

`npx shadcn@latest add @aceternity/stateful-button-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/stateful-button-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/stateful-button-demo.json)

Send message

## [Link to section](https://ui.aceternity.com/components/stateful-button\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/stateful-button\#props) Props
...
Inspired by the design of buttons on [Family](https://family.co/)
