...
[card](https://ui.aceternity.com/categories/card) [3D](https://ui.aceternity.com/categories/3d) [tilt](https://ui.aceternity.com/categories/tilt)

PreviewCode

`npx shadcn@latest add @aceternity/comet-card-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/comet-card-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/comet-card-demo.json)

![Invite background](https://images.unsplash.com/photo-1505506874110-6a7a69069a08?q=80&w=1287&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)

Comet Invitation

#F7RA

## [Link to section](https://ui.aceternity.com/components/comet-card\#installation) Installation
...
#### [Link to section](https://ui.aceternity.com/components/comet-card\#props) Props

| Prop | Type | Default | Description | Required |
| --- | --- | --- | --- | --- |
| `rotateDepth` | `number` | `17.5` | Controls the depth of 3D rotation effect on mouse movement. Higher values create more dramatic rotation. | No |
| `translateDepth` | `number` | `20` | Controls the depth of translation (movement) effect on mouse movement. Higher values create more dramatic movement. | No |
| `className` | `string` | undefined | Additional CSS classes to apply to the card container. | No |
| `children` | `React.ReactNode` | - | The content to be rendered inside the card. | Yes |
