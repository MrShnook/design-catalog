...
[loaders](https://ui.aceternity.com/categories/loaders) [loader](https://ui.aceternity.com/categories/loader) [loading](https://ui.aceternity.com/categories/loading)

PreviewCode

`npx shadcn@latest add @aceternity/loader-one-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/loader-one-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/loader-one-demo.json)

## [Link to section](https://ui.aceternity.com/components/loader\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/loader\#simple-loader) Simple Loader
...
## [Link to section](https://ui.aceternity.com/components/loader\#shimmer-loader) Shimmer Loader

PreviewCode

`npx shadcn@latest add @aceternity/loader-five-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/loader-five-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/loader-five-demo.json)

Generatingchat...

## [Link to section](https://ui.aceternity.com/components/loader\#compact-loader) Compact Loader

PreviewCode

`npx shadcn@latest add @aceternity/loader-two-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/loader-two-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/loader-two-demo.json)

## [Link to section](https://ui.aceternity.com/components/loader\#svg-loader) SVG Loader

PreviewCode

`npx shadcn@latest add @aceternity/loader-three-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/loader-three-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/loader-three-demo.json)

## [Link to section](https://ui.aceternity.com/components/loader\#glitch-loader) Glitch Loader

PreviewCode

`npx shadcn@latest add @aceternity/loader-four-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/loader-four-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/loader-four-demo.json)
