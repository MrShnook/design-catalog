...
[special](https://ui.aceternity.com/categories/special) [utilities](https://ui.aceternity.com/categories/utilities) [card](https://ui.aceternity.com/categories/card)

PreviewCode

`npx shadcn@latest add @aceternity/glare-card-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/glare-card-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/glare-card-demo.json)

Aceternity

## [Link to section](https://ui.aceternity.com/components/glare-card\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/glare-card\#examples) Examples

PreviewCode

`npx shadcn@latest add @aceternity/glare-card-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/glare-card-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/glare-card-demo-2.json)

![Abstract colorful gradient background](https://images.unsplash.com/photo-1512618831669-521d4b375f5d?q=80&w=3388&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)

The greatest trick

The greatest trick the devil ever pulled was to convince the world that he didn't exist.

## [Link to section](https://ui.aceternity.com/components/glare-card\#props) Props
...
This component is inspired by [Linear's customers page](https://linear.app/customers)
