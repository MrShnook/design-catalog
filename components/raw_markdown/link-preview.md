...
[text](https://ui.aceternity.com/categories/text) [special](https://ui.aceternity.com/categories/special) [utilities](https://ui.aceternity.com/categories/utilities)

PreviewCode

`npx shadcn@latest add @aceternity/link-preview-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/link-preview-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/link-preview-demo.json)

![hidden image](https://api.microlink.io/?url=https%3A%2F%2Ftailwindcss.com&screenshot=true&meta=false&embed=screenshot.url&colorScheme=dark&viewport.isMobile=true&viewport.deviceScaleFactor=1&viewport.width=600&viewport.height=375)

[Tailwind CSS](https://tailwindcss.com/) and

![hidden image](https://api.microlink.io/?url=https%3A%2F%2Fframer.com%2Fmotion&screenshot=true&meta=false&embed=screenshot.url&colorScheme=dark&viewport.isMobile=true&viewport.deviceScaleFactor=1&viewport.width=600&viewport.height=375)

[Framer Motion](https://framer.com/motion) are a great way to build modern websites.

Visit

![hidden image](https://api.microlink.io/?url=https%3A%2F%2Fui.aceternity.com&screenshot=true&meta=false&embed=screenshot.url&colorScheme=dark&viewport.isMobile=true&viewport.deviceScaleFactor=1&viewport.width=600&viewport.height=375)

[Aceternity UI](https://ui.aceternity.com/) for amazing Tailwind and Framer Motion components.

## [Link to section](https://ui.aceternity.com/components/link-preview\#installation) Installation
...
module.exports = nextConfig;CopySelect Language
```

## [Link to section](https://ui.aceternity.com/components/link-preview\#static-image-preview-example) Static Image Preview Example

PreviewCode

`npx shadcn@latest add @aceternity/link-preview-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/link-preview-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/link-preview-demo-2.json)

Visit

![hidden image](https://api.microlink.io/?url=https%3A%2F%2Fui.aceternity.com&screenshot=true&meta=false&embed=screenshot.url&colorScheme=dark&viewport.isMobile=true&viewport.deviceScaleFactor=1&viewport.width=600&viewport.height=375)

[Aceternity UI](https://ui.aceternity.com/) and for amazing Tailwind and Framer Motion components.

I listen to

![hidden image](https://ui.aceternity.com/images/imraan-hashmi.jpeg)

[this guy](https://www.youtube.com/watch?v=S-z6vyR89Ig&list=RDMM&index=3) and I watch

![hidden image](https://ui.aceternity.com/images/fight-club.jpeg)

[this movie](https://ui.aceternity.com/templates) twice a day
...
## [Link to section](https://ui.aceternity.com/components/link-preview\#props) Props
