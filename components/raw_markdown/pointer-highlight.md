...
[pointer](https://ui.aceternity.com/categories/pointer) [highlight](https://ui.aceternity.com/categories/highlight) [text](https://ui.aceternity.com/categories/text)

PreviewCode

`npx shadcn@latest add @aceternity/pointer-highlight-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/pointer-highlight-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/pointer-highlight-demo.json)

The best way to grow is to

collaborate

## [Link to section](https://ui.aceternity.com/components/pointer-highlight\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/pointer-highlight\#examples) Examples

#### [Link to section](https://ui.aceternity.com/components/pointer-highlight\#inline-highlight) Inline Highlight

PreviewCode

`npx shadcn@latest add @aceternity/pointer-highlight-demo-3`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/pointer-highlight-demo-3) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/pointer-highlight-demo-3.json)
...
#### [Link to section](https://ui.aceternity.com/components/pointer-highlight\#color-variation) Color Variation

PreviewCode

`npx shadcn@latest add @aceternity/pointer-highlight-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/pointer-highlight-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/pointer-highlight-demo-2.json)

There has to be some

background to animate too

## [Link to section](https://ui.aceternity.com/components/pointer-highlight\#props) Props
