...
`npx shadcn@latest add @aceternity/placeholders-and-vanish-input-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/placeholders-and-vanish-input-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/placeholders-and-vanish-input-demo.json)
