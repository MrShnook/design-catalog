...
[text](https://ui.aceternity.com/categories/text) [special](https://ui.aceternity.com/categories/special) [features](https://ui.aceternity.com/categories/features) [hero](https://ui.aceternity.com/categories/hero)

PreviewCode

`npx shadcn@latest add @aceternity/colourful-text-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/colourful-text-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/colourful-text-demo.json)

![](https://assets.aceternity.com/linear-demo.webp)

# The best components   you will ever find

## [Link to section](https://ui.aceternity.com/components/colourful-text\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/colourful-text\#props) Props

## [Link to section](https://ui.aceternity.com/components/colourful-text\#colourfultext-props) ColourfulText Props
