...
[hero](https://ui.aceternity.com/categories/hero) [features](https://ui.aceternity.com/categories/features) [product](https://ui.aceternity.com/categories/product) [utility](https://ui.aceternity.com/categories/utility)

PreviewCode

`npx shadcn@latest add @aceternity/tabs-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/tabs-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/tabs-demo.json)

ProductServicesPlaygroundContentRandom

Product Tab

![dummy image](https://ui.aceternity.com/linear.webp)
...
## [Link to section](https://ui.aceternity.com/components/tabs\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/tabs\#props) Props
