...
`npx shadcn@latest add @aceternity/background-boxes-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/background-boxes-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/background-boxes-demo.json)

# Tailwind is Awesome

Framer motion is the best animation library ngl

## [Link to section](https://ui.aceternity.com/components/background-boxes\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/background-boxes\#props) Props
