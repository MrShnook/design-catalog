...
`npx shadcn@latest add @aceternity/background-beams-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/background-beams-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/background-beams-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/background-beams\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/background-beams\#props) Props
