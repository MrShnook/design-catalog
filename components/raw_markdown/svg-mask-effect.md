...
`npx shadcn@latest add @aceternity/svg-mask-effect-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/svg-mask-effect-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/svg-mask-effect-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/svg-mask-effect\#installation) Installation
...
</svg>CopySelect Language
```

## [Link to section](https://ui.aceternity.com/components/svg-mask-effect\#props) Props
