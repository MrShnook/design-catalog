...
[background](https://ui.aceternity.com/categories/background) [special](https://ui.aceternity.com/categories/special) [effects](https://ui.aceternity.com/categories/effects) [hero](https://ui.aceternity.com/categories/hero)

PreviewCode

`npx shadcn@latest add @aceternity/background-lines-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/background-lines-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/background-lines-demo.json)

## Sanjana Airlines,    Sajana Textiles.

Get the best advices from our experts, including expert artists, painters, marathon enthusiasts and RDX, totally free.

## [Link to section](https://ui.aceternity.com/components/background-lines\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/background-lines\#props) Props
...
This component is inspired from the background section of [height.app](https://height.app/).
