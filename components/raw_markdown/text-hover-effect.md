...
[hover](https://ui.aceternity.com/categories/hover) [special](https://ui.aceternity.com/categories/special) [text](https://ui.aceternity.com/categories/text)

PreviewCode

`npx shadcn@latest add @aceternity/text-hover-effect-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/text-hover-effect-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/text-hover-effect-demo.json)

ACETACETACET

## [Link to section](https://ui.aceternity.com/components/text-hover-effect\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/text-hover-effect\#props) Props
...
The initial code of this component is contributed by [Sudhanshu Mishra](https://x.com/Knight_s18)
