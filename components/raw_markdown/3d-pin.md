...
[card](https://ui.aceternity.com/categories/card) [hover](https://ui.aceternity.com/categories/hover) [special](https://ui.aceternity.com/categories/special)

PreviewCode

`npx shadcn@latest add @aceternity/3d-pin-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/3d-pin-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/3d-pin-demo.json)

[**Aceternity UI** \\
\\
Customizable Tailwind CSS and Framer Motion Components.](https://twitter.com/mannupaaji)

[/ui.aceternity.com](https://twitter.com/mannupaaji)

## [Link to section](https://ui.aceternity.com/components/3d-pin\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/3d-pin\#props) Props
