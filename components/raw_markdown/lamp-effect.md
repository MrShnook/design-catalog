...
[section](https://ui.aceternity.com/categories/section) [header](https://ui.aceternity.com/categories/header) [special](https://ui.aceternity.com/categories/special)

PreviewCode

`npx shadcn@latest add @aceternity/lamp-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/lamp-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/lamp-demo.json)

# Build lamps    the right way

## [Link to section](https://ui.aceternity.com/components/lamp-effect\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/lamp-effect\#props) Props
