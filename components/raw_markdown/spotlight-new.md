...
`npx shadcn@latest add @aceternity/spotlight-new-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/spotlight-new-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/spotlight-new-demo.json)

# Spotlight    which is not overused.

A subtle yet effective spotlight effect, because the previous version is used a bit too much these days.

## [Link to section](https://ui.aceternity.com/components/spotlight-new\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/spotlight-new\#props) Props
