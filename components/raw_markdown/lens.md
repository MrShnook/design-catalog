...
[content](https://ui.aceternity.com/categories/content) [special](https://ui.aceternity.com/categories/special) [effects](https://ui.aceternity.com/categories/effects) [cards](https://ui.aceternity.com/categories/cards)

PreviewCode

`npx shadcn@latest add @aceternity/lens-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/lens-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/lens-demo.json)

![image](https://images.unsplash.com/photo-1713869820987-519844949a8a?q=80&w=3500&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)

## Apple Vision Pro

The all new apple vision pro was the best thing that happened around 8 months ago, not anymore.

## [Link to section](https://ui.aceternity.com/components/lens\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/lens\#examples) Examples

### [Link to section](https://ui.aceternity.com/components/lens\#basic-with-animation) Basic with Animation
...
### [Link to section](https://ui.aceternity.com/components/lens\#static) Static

PreviewCode

`npx shadcn@latest add @aceternity/lens-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/lens-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/lens-demo-2.json)
...
### [Link to section](https://ui.aceternity.com/components/lens\#lens-on-a-react-component) Lens on a React Component

PreviewCode

`npx shadcn@latest add @aceternity/lens-demo-3`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/lens-demo-3) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/lens-demo-3.json)
...
## [Link to section](https://ui.aceternity.com/components/lens\#props) Props
