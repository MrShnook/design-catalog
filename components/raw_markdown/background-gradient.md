...
`npx shadcn@latest add @aceternity/background-gradient-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/background-gradient-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/background-gradient-demo.json)

![jordans](https://ui.aceternity.com/jordans.webp)
...
## [Link to section](https://ui.aceternity.com/components/background-gradient\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/background-gradient\#props) Props
