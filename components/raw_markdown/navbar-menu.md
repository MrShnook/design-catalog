...
`npx shadcn@latest add @aceternity/navbar-menu-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/navbar-menu-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/navbar-menu-demo.json)

The Navbar will show on top of the page

## [Link to section](https://ui.aceternity.com/components/navbar-menu\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/navbar-menu\#props) Props
