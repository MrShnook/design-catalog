...
`npx shadcn@latest add @aceternity/typewriter-effect-demo-1`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/typewriter-effect-demo-1) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/typewriter-effect-demo-1.json)
...
## [Link to section](https://ui.aceternity.com/components/typewriter-effect\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/typewriter-effect\#example) Example

A more janky animation to give a typing effect.

PreviewCode

`npx shadcn@latest add @aceternity/typewriter-effect-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/typewriter-effect-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/typewriter-effect-demo-2.json)
...
## [Link to section](https://ui.aceternity.com/components/typewriter-effect\#props) Props
