...
[card](https://ui.aceternity.com/categories/card) [testimonials](https://ui.aceternity.com/categories/testimonials) [features](https://ui.aceternity.com/categories/features)

## [Link to section](https://ui.aceternity.com/components/cards-free\#installation) Installation
...
export default config;CopySelect Language
```

#### [Link to section](https://ui.aceternity.com/components/cards-free\#feature-block-animated-card) Feature Block Animated Card

PreviewCode

`npx shadcn@latest add @aceternity/cards-demo-3`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/cards-demo-3) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/cards-demo-3.json)

### Damn good card

A card that showcases a set of tools that you use to create your product.

#### [Link to section](https://ui.aceternity.com/components/cards-free\#background-overlay-card) Background Overlay Card

PreviewCode

`npx shadcn@latest add @aceternity/cards-demo-1`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/cards-demo-1) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/cards-demo-1.json)

# Background Overlays

This card is for some special elements, like displaying background gifs on hover only.

#### [Link to section](https://ui.aceternity.com/components/cards-free\#content-card) Content Card

PreviewCode

`npx shadcn@latest add @aceternity/cards-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/cards-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/cards-demo-2.json)

![Avatar](https://ui.aceternity.com/manu.png)
