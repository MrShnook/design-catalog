...
[banner](https://ui.aceternity.com/categories/banner) [sticky](https://ui.aceternity.com/categories/sticky) [hero](https://ui.aceternity.com/categories/hero)

PreviewCode

`npx shadcn@latest add @aceternity/sticky-banner-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/sticky-banner-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/sticky-banner-demo.json)

Announcing $10M seed funding from project mayhem ventures. [Read announcement](https://ui.aceternity.com/components/sticky-banner#)

## [Link to section](https://ui.aceternity.com/components/sticky-banner\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/sticky-banner\#examples) Examples

#### [Link to section](https://ui.aceternity.com/components/sticky-banner\#sticky-banner) Sticky banner
...
## [Link to section](https://ui.aceternity.com/components/sticky-banner\#props) Props
