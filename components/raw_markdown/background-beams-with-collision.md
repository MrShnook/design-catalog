...
[ui](https://ui.aceternity.com/categories/ui) [background](https://ui.aceternity.com/categories/background)

PreviewCode

`npx shadcn@latest add @aceternity/background-beams-with-collision-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/background-beams-with-collision-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/background-beams-with-collision-demo.json)

## What's cooler than Beams?     Exploding beams.    Exploding beams.

## [Link to section](https://ui.aceternity.com/components/background-beams-with-collision\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/background-beams-with-collision\#props) Props

### [Link to section](https://ui.aceternity.com/components/background-beams-with-collision\#backgroundbeamswithcollision) BackgroundBeamsWithCollision
...
### [Link to section](https://ui.aceternity.com/components/background-beams-with-collision\#collisionmechanism) CollisionMechanism
...
### [Link to section](https://ui.aceternity.com/components/background-beams-with-collision\#beamoptions) beamOptions
