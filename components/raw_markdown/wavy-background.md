...
[background](https://ui.aceternity.com/categories/background) [special](https://ui.aceternity.com/categories/special)

PreviewCode

`npx shadcn@latest add @aceternity/wavy-background-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/wavy-background-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/wavy-background-demo.json)

Hero waves are cool

Leverage the power of canvas to create a beautiful hero section

## [Link to section](https://ui.aceternity.com/components/wavy-background\#installation) Installation
