...
[hover](https://ui.aceternity.com/categories/hover) [card](https://ui.aceternity.com/categories/card) [utility](https://ui.aceternity.com/categories/utility) [button](https://ui.aceternity.com/categories/button)

PreviewCode

`npx shadcn@latest add @aceternity/hover-border-gradient-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/hover-border-gradient-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/hover-border-gradient-demo.json)

Aceternity UI

## [Link to section](https://ui.aceternity.com/components/hover-border-gradient\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/hover-border-gradient\#props) Props
