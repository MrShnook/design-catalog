...
`npx shadcn@latest add @aceternity/keyboard-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/keyboard-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/keyboard-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/keyboard\#installation) Installation
...
- [sound.ogg](https://ui.aceternity.com/sounds/sound.ogg) \- Audio sprite file
- [config.json](https://ui.aceternity.com/sounds/config.json) \- Sound timing configuration

## [Link to section](https://ui.aceternity.com/components/keyboard\#examples) Examples

#### [Link to section](https://ui.aceternity.com/components/keyboard\#keyboard-demo-with-sound) Keyboard Demo With Sound
...
#### [Link to section](https://ui.aceternity.com/components/keyboard\#keyboard-demo-without-sound) Keyboard Demo Without Sound

PreviewCode

`npx shadcn@latest add @aceternity/keyboard-no-sound-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/keyboard-no-sound-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/keyboard-no-sound-demo.json)
...
#### [Link to section](https://ui.aceternity.com/components/keyboard\#keyboard-demo-with-preview) Keyboard Demo With Preview

PreviewCode

`npx shadcn@latest add @aceternity/keyboard-with-preview-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/keyboard-with-preview-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/keyboard-with-preview-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/keyboard\#props) Props
...
### [Link to section](https://ui.aceternity.com/components/keyboard\#notes) Notes
