...
`npx shadcn@latest add @aceternity/noise-background-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/noise-background-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/noise-background-demo.json)

![](https://assets.aceternity.com/noise.webp)

Start publishing →

## [Link to section](https://ui.aceternity.com/components/noise-background\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/noise-background\#example-background) Example Background

PreviewCode

`npx shadcn@latest add @aceternity/noise-background-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/noise-background-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/noise-background-demo-2.json)

![](https://assets.aceternity.com/noise.webp)

![Task Complete](https://assets.aceternity.com/blog/how-to-create-a-bento-grid.png)

### How to create a bento grid with Tailwind

Learn how to create a bento grid with Tailwind CSS, Next.js and Framer Motion.

## [Link to section](https://ui.aceternity.com/components/noise-background\#props) Props

#### [Link to section](https://ui.aceternity.com/components/noise-background\#noisebackground-props) NoiseBackground Props
