...
[features](https://ui.aceternity.com/categories/features) [special](https://ui.aceternity.com/categories/special) [highlights](https://ui.aceternity.com/categories/highlights)

PreviewCode

`npx shadcn@latest add @aceternity/cover-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/cover-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/cover-demo.json)

# Build amazing websites    at   warp speed

## [Link to section](https://ui.aceternity.com/components/container-cover\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/container-cover\#props) Props
