...
[background](https://ui.aceternity.com/categories/background) [card](https://ui.aceternity.com/categories/card) [utility](https://ui.aceternity.com/categories/utility)

PreviewCode

`npx shadcn@latest add @aceternity/grid-background-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/grid-background-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/grid-background-demo.json)

Backgrounds

## [Link to section](https://ui.aceternity.com/components/grid-and-dot-backgrounds\#installation) Installation

### Install dependencies

```
npm i motion clsx tailwind-mergeCopy
```
...
## [Link to section](https://ui.aceternity.com/components/grid-and-dot-backgrounds\#examples) Examples

### [Link to section](https://ui.aceternity.com/components/grid-and-dot-backgrounds\#grid-background) Grid Background
...
### [Link to section](https://ui.aceternity.com/components/grid-and-dot-backgrounds\#grid-small-background) Grid Small Background

PreviewCode

`npx shadcn@latest add @aceternity/grid-small-background-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/grid-small-background-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/grid-small-background-demo.json)

Backgrounds

### [Link to section](https://ui.aceternity.com/components/grid-and-dot-backgrounds\#dot-background) Dot Background

PreviewCode

`npx shadcn@latest add @aceternity/dot-background-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/dot-background-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/dot-background-demo.json)
