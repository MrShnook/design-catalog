...
`npx shadcn@latest add @aceternity/aurora-background-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/aurora-background-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/aurora-background-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/aurora-background\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/aurora-background\#props) Props
...
This component is ideated and initialized by [Akshith Pottigari](https://twitter.com/akshith_1805)
