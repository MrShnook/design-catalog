...
[logo](https://ui.aceternity.com/categories/logo) [clouds](https://ui.aceternity.com/categories/clouds)

### \#\# Installation

## [Link to section](https://ui.aceternity.com/blocks/logo-clouds\#logos-with-blur-flip) Logos with Blur Flip

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/logos-with-blur-flip)

## Trusted by the best companies

Companies that have been using our product from the very start.

![Aceternity UI](https://assets.aceternity.com/pro/logos/aceternity-ui.png)

![Gamity](https://assets.aceternity.com/pro/logos/gamity.png)

![Host it](https://assets.aceternity.com/pro/logos/hostit.png)

![Asteroid Kit](https://assets.aceternity.com/pro/logos/asteroid-kit.png)

## [Link to section](https://ui.aceternity.com/blocks/logo-clouds\#logo-cloud-with-blur-animation) Logo Cloud With Blur Animation

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/logo-cloud-with-blur-animation)

## Trusted by modern operators across industries.    From pilot to scale without chaos.

![Open AI](https://assets.aceternity.com/logos/openai.png)

![Hello Patient](https://assets.aceternity.com/logos/hello-patient.png)

![Granola](https://assets.aceternity.com/logos/granola.png)

![Character AI](https://assets.aceternity.com/logos/characterai.png)

![Oracle](https://assets.aceternity.com/logos/oracle.png)

![Portola](https://assets.aceternity.com/logos/portola.png)

## [Link to section](https://ui.aceternity.com/blocks/logo-clouds\#logo-cloud-marquee) Logo Cloud Marquee

Install `react-fast-marquee` for this component

```
npm i react-fast-marqueeCopy
```

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/logo-cloud-marquee)
...
![Aceternity UI 2](https://assets.aceternity.com/pro/logos/aceternity-ui.png)

![Gamity 2](https://assets.aceternity.com/pro/logos/gamity.png)

![Host it 2](https://assets.aceternity.com/pro/logos/hostit.png)

![Asteroid Kit 2](https://assets.aceternity.com/pro/logos/asteroid-kit.png)
...
## [Link to section](https://ui.aceternity.com/blocks/logo-clouds\#spotlight-logo-cloud) Spotlight Logo Cloud

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/spotlight-logo-cloud)
