...
[auth](https://ui.aceternity.com/categories/auth) [registration](https://ui.aceternity.com/categories/registration) [login](https://ui.aceternity.com/categories/login) [form](https://ui.aceternity.com/categories/form)

### \#\# Installation

## [Link to section](https://ui.aceternity.com/blocks/login-and-signup-sections\#login-form-with-gradient) Login Form With Gradient

### Install dependencies

`bash npm i motion @radix-ui/react-label`

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/login-form-with-gradient)
...
Already have an account? [Sign up](https://ui.aceternity.com/blocks/login-and-signup-sections#)
...
## [Link to section](https://ui.aceternity.com/blocks/login-and-signup-sections\#premium-auth-split) Premium Auth Split

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/premium-auth-split)
...
Don't have an account? [Sign up](https://ui.aceternity.com/blocks/login-and-signup-sections#)

© Nexus · [Privacy](https://ui.aceternity.com/blocks/login-and-signup-sections#) · [Terms](https://ui.aceternity.com/blocks/login-and-signup-sections#)

## [Link to section](https://ui.aceternity.com/blocks/login-and-signup-sections\#registration-form-with-images) Registration Form With Images

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/registration-form-with-images)

[![logo](https://assets.aceternity.com/logo-dark.png)DevStudio](https://ui.aceternity.com/)
...
Already have an account? [Sign in](https://ui.aceternity.com/blocks/login-and-signup-sections#)

Or continue with

Github

By clicking on sign up, you agree to our [Terms of Service](https://ui.aceternity.com/blocks/login-and-signup-sections#) and [Privacy Policy](https://ui.aceternity.com/blocks/login-and-signup-sections#)
...
DevStudio is loved by thousands of people across the world, be part of the community and join us.

## [Link to section](https://ui.aceternity.com/blocks/login-and-signup-sections\#login-with-socials-and-email) Login With Socials And Email

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/login-with-socials-and-email)

[![logo](https://assets.aceternity.com/logo-dark.png)DevStudio](https://ui.aceternity.com/)

# Sign in to your account

Login with GitHubLogin with Google

Continue with Email

## [Link to section](https://ui.aceternity.com/blocks/login-and-signup-sections\#login-signup-minimal) Login Signup Minimal

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/login-signup-minimal)

[Nexus](https://ui.aceternity.com/)
...
Password [Forgot?](https://ui.aceternity.com/blocks/login-and-signup-sections#)
