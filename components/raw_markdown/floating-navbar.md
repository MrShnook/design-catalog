...
[navbar](https://ui.aceternity.com/categories/navbar) [utility](https://ui.aceternity.com/categories/utility)

PreviewCode

`npx shadcn@latest add @aceternity/floating-navbar-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/floating-navbar-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/floating-navbar-demo.json)

[Home](https://ui.aceternity.com/) [About](https://ui.aceternity.com/components/floating-navbar#about) [Contact](https://ui.aceternity.com/components/floating-navbar#contact)

Login

Scroll back up to reveal Navbar

## [Link to section](https://ui.aceternity.com/components/floating-navbar\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/floating-navbar\#props) Props
