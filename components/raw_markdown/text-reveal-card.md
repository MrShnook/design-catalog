...
[text](https://ui.aceternity.com/categories/text) [content](https://ui.aceternity.com/categories/content) [hero](https://ui.aceternity.com/categories/hero) [section](https://ui.aceternity.com/categories/section) [special](https://ui.aceternity.com/categories/special) [card](https://ui.aceternity.com/categories/card)

PreviewCode

`npx shadcn@latest add @aceternity/text-reveal-card-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/text-reveal-card-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/text-reveal-card-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/text-reveal-card\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/text-reveal-card\#props) Props
