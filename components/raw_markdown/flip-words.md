...
[text](https://ui.aceternity.com/categories/text) [hero](https://ui.aceternity.com/categories/hero) [special](https://ui.aceternity.com/categories/special) [call to action](https://ui.aceternity.com/categories/call-to-action)

PreviewCode

`npx shadcn@latest add @aceternity/flip-words-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/flip-words-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/flip-words-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/flip-words\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/flip-words\#props) Props
...
This component is inspired by the words animation on [Antimetal's website](https://antimetal.com/).
