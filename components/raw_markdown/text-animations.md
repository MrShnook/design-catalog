...
[text](https://ui.aceternity.com/categories/text) [headings](https://ui.aceternity.com/categories/headings) [paragraphs](https://ui.aceternity.com/categories/paragraphs)

### \#\# Installation

## [Link to section](https://ui.aceternity.com/blocks/text-animations\#text-animation-flipping-words) Text Animation Flipping Words

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/text-animation-flipping-words-demo)

# Built with Next.js

Create stunning animations that bring your website to life. Elevate your user experience with smooth transitions and eye-catching effects that captivate visitors and keep them engaged.
...
See what others are building with our tools

## [Link to section](https://ui.aceternity.com/blocks/text-animations\#text-animation-typewriter-effect) Text Animation Typewriter Effect

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/text-animation-typewriter-effect-demo)

# Build awesome websites    withNext.js

Create stunning animated text effects with our typewriter component. Perfect for landing pages, portfolios, and interactive experiences.

Get Started→✨View Examples

## [Link to section](https://ui.aceternity.com/blocks/text-animations\#text-animation-blur-fade-in) Text Animation Blur Fade In

PreviewCode

[Open in full screen](https://ui.aceternity.com/live-preview/text-animation-blur-fade-in-demo)

Animations that stand out from the rest.

Appearing text sets aside the text from the rest, it is a great way to make the text more engaging and interesting.
